...
def po_qsd(V: np.ndarray, wires: list) -> list:
    ...
    with qml.QueuingManager.stop_recording():
        ...
        F_10, Delta_10 = recursive_flag_decomp_cliff_rz(
            M10_new * Delta_11, controls, n_b=2, selective_demux=True
        )
        F_01, Delta_01 = recursive_flag_decomp_cliff_rz(
            M01_new * Delta_10, controls, n_b=2, selective_demux=True
        )
