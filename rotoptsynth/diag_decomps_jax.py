...
from .asym_decomp_jax import asymmetric_two_qubit_decomp
...
def _diag_decomp_two_qubits(u: np.ndarray, wires: WiresLike) -> tuple[Operator, list[Operator]]:
    ...
    with qml.QueuingManager.stop_recording():
        ...
        diagonal = _diag_from_angles(jnp.array([rz.data[0], c_rz0.data[0], d_rz0.data[0], gphase.data[0]]))
